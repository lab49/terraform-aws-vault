...
variable "ca_public_key_file_path" {
  ...
  default = "/Users/kruttik.aggarwal/Documents/workspace-sre/terraform-aws-vault/modules/private-tls-cert/ca.crt.pem"
}

variable "public_key_file_path" {
  description = "Write the PEM-encoded certificate public key to this path (e.g. /etc/tls/vault.crt.pem)."
  default = "/Users/kruttik.aggarwal/Documents/workspace-sre/terraform-aws-vault/modules/private-tls-cert/vault.crt.pem"
}

variable "private_key_file_path" {
  description = "Write the PEM-encoded certificate private key to this path (e.g. /etc/tls/vault.key.pem)."
  default = "/Users/kruttik.aggarwal/Documents/workspace-sre/terraform-aws-vault/modules/private-tls-cert/vault.key.pem"
}

variable "owner" {
  description = "The OS user who should be given ownership over the certificate files."
  default = "kruttik.aggarwal"
}
...
variable "dns_names" {
  ...
  type        = "list"
  default = ["vault.service.consul", "nonpod-vault.lab49aws.com"]
}
